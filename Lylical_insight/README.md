...
기존의 단순 키워드 매칭 방식 뮤직비디오 생성 시스템의 한계를 극복하기 위해, **LLM(Large Language Model) 기반의 맥락 분석**을 도입한 고도화 프로젝트입니다.
...
1. **Extraction**: Selenium을 이용해 동적 웹(Melon)에서 실시간 차트 가사 데이터 수집.
...
<img width="1254" height="1320" alt="1" src="https://github.com/user-attachments/assets/6d72f3af-d607-41a0-9a34-2e5613e57c35" />
---
...
- **Solution**: `WebDriverWait`와 `Try-Except`를 활용한 예외 처리 로직을 구축하여 수집 성공률 극대화.
